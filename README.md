...
*Three rigid links, hinged end to end, balanced above one moving cart. The motor slides the cart left and right to hold the whole articulated pole upright: first one link, then two, then all three.*
